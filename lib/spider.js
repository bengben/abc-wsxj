...
var spider = {
  ...
  async getInfoById(id) {
    var url = "https://xj.ccgp-chongqing.gov.cn/enquiry/notice!enquiryNotice.action?notic_seq="+id;
    superagent.get(url).end((err, res) => {
      // Do something
      $ = cheerio.load(res.text);
      console.log($('.notice-alert').text());
      // console.log($('.notice-item-title').text());
      return $('.notice-item-title').text();
    });
